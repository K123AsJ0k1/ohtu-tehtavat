...
public class Stepdefs {
    ...
    public void nonexistentUserIsGiven(String username, String password) throws Throwable {
        logInWith(username, password);
    }
    ...
    public void shortUsernameError(String username, String password) throws Throwable {
        signUpWith(username, password);
    }

    @When("a correct username {string} and a short password {string} are entered")
    public void shortPasswordError(String username, String password) throws Throwable {
        signUpWith(username, password);
    }

    @When("a valid username {string}, a valid password {string} and an incorrect confirmation {string} are entered")
    ...
    public void userCreationResponse() {
        assertTrue(driver.getPageSource().contains("Welcome to Ohtu Application!"));
    }

    @Then("user is not created and error {string} is reported") 
    public void userIsNotCreated(String pageContent) throws Throwable {
        assertTrue(driver.getPageSource().contains(pageContent));
    }
